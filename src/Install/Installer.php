...
final class Installer
{
     ...
     *
     * PrestaShop runs only the scripts in `upgrade/` when a module is updated, never `install()`,
     * so both paths call this method. The DDL is idempotent: CREATE TABLE IF NOT EXISTS plus
